  ...
  return (
    <div className='position-relative ' style={{ paddingTop: '10px', width: '100%' }}>
      ...
      <div className='d-flex align-items-center position-absolute start-0' style={{ paddingTop: '14px', paddingLeft: '115px' }}>
        ...
        <a href="https://www.linkedin.com" className='text-dark fs-3 me-3' target="_blank" rel="noopener noreferrer">
          <i className="bi bi-linkedin"></i> {/* Ícone do LinkedIn */}
        </a>
        <a href="https://www.youtube.com" className='text-dark fs-3 me-3' target="_blank" rel="noopener noreferrer">
          <i className="bi bi-youtube"></i> {/* Ícone do YouTube */}
        </a>
        <a href="https://www.facebook.com" className='text-dark fs-3 me-3' target="_blank" rel="noopener noreferrer">
        ...
        <a href="https://www.tiktok.com" className='text-dark fs-3' target="_blank" rel="noopener noreferrer">
